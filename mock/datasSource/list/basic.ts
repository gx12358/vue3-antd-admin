...
export default [
  ...
  getMockRequest<Partial<BasicListItemDataType>>({
    ...
    timeout: 200,
    callback: ({ body }) => {
      dataSource = postDataSource<BasicListItemDataType>(dataSource, 'add', { key: 'id', params: body })
  ...
  getMockRequest<Partial<BasicListItemDataType>>({
    ...
    timeout: 200,
    callback: ({ body }) => {
      dataSource = postDataSource<BasicListItemDataType>(dataSource, 'update', { key: 'id', params: body })
  ...
  getMockRequest<Partial<BasicListItemDataType>>({
    ...
    timeout: 200,
    callback: ({ query }) => {
      dataSource = postDataSource<BasicListItemDataType>(dataSource, 'delete', { key: 'id', params: query })
