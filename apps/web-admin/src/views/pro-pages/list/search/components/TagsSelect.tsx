...
export type TagsValue = string | number

const TagsSelect = defineComponent({
  inheritAttrs: false,
  name: 'TagsSelect',
  props: {
    value: [ String, Array ] as PropType<TagsValue[] | TagsValue>,
    data: {
    ...
    'onUpdate:value': Function as PropType<(value: TagsValue[] | TagsValue) => void>,
    onChange: Function as PropType<(value: TagsValue[] | TagsValue) => void>
  },
  ...
  setup(props, { emit }) {
    ...
    const handleCheckValue = () => {
      if (props.selectType === 'checkbox')
        return props.value as TagsValue[]
      if (props.selectType === 'radio')
        return [ props.value ] as TagsValue[]
      return [] as TagsValue[]
    }

    const [ checkValue, changeCheckList ] = useMergedState<TagsValue[]>(handleCheckValue, {
    ...
    const changeCheckValue = (value: TagsValue, checked: boolean) => {
      if (props.selectType === 'radio') {
