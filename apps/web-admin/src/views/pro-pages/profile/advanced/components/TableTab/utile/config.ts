...
import { getAdvancedTable1, getAdvancedTable2, getAdvancedTable3 } from '@/services/profile-center'
...
export const columns: ProColumnsType<AdvancedTableRecord, ListSearchParams> = [
  {
    title: '操作类型',
    dataIndex: 'type',
    key: 'type'
